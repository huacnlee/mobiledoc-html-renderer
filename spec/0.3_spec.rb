...
module ZeroThreeZero
  ...
  describe Mobiledoc::HTMLRenderer, "(#{MOBILEDOC_VERSION})" do
    ...
    it "throws when given atom with invalid type" do
      ...
      expect { Mobiledoc::HTMLRenderer.new(atoms: [bad_atom]) }.to raise_error('Atom "bad" must be of type "html", was "other"')
    end
    ...
    it "throws when given atom without `render`" do
      ...
      expect { Mobiledoc::HTMLRenderer.new(atoms: [bad_atom]) }.to raise_error('Atom "bad" must define `render`')
    end
    ...
    it "throws when rendering unknown atom without unknown_atom_handler" do
      ...
      expect { renderer.render(mobiledoc) }.to raise_error('Atom "missing-atom" not found')
    end
